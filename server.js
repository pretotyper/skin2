                ...
                messages: [
                    {
                        ...
                        content: [
                            {
                                type: "text",
                                text: `등록한 3장의 사진과 총 예산 ${budget}에 맞게 피부 분석 후 예상 연령대와 특징을 자세히 설명해줘.
                                분석 결과에 맞는 피부 관리 제품과 루틴을 한글로 추천해줘, 이때 제품은 아침 루틴, 저녁 루틴으로 구분해서 설명하되 쿠팡에서 구매 가능한 제품으로 추천해줘. 단, 제품의 효과, 성분, 가격도 알려주고, 링크는 제공하지마.
                                그리고 예산 상관없이 피부에 맞는 피부 시술을 추천해주고 시술당 평균 가격을 알려줘. 
                                ...
                                각 타이틀 뒤에 ':' 는 빼줘
                                피부 관리 제품과 루틴을 추천하는 영역은 너무 줄바꿈 하지말고, '아침 루틴', '저녁 루틴'은 [아침 루틴], [저녁 루틴] 형태로 해주고, #### 정도 크기로 해줘
